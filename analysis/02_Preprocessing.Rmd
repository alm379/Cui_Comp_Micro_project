...
metadata_df <- read.csv("data/Cui_Constructed_Metadata.csv")
...
# Evaulate and remove the control samples - No controls or mock communities in this study, not applicable for this dataset.
...
# Density plot 
seqSums_df %>%
  ggplot(aes(TotalSeqs, fill = n_level)) +
