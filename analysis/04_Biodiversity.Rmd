...
```{r div-dfs}
n_level_names <- c(0,150,300)
names(n_level_names) <- c("Low N","Med N","High N")
planted_names <- c ("Planted", "Unplanted")
names(planted_names) <- c ("Plant", "No\nPlant")
growth_stage_names <- c("30","75")
names(growth_stage_names) <- c("Day 30","Day75")
...
# Boxplots by plant vs no plant

## Boxplots by sampling date
